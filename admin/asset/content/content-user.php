    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span12">
                ...
                <h3> Daftar Anggota</h3> <a href="dashboard.php?page=user-tambah"><button class="btn btn-success"><i class="icon-plus" style="margin-right:2px;color:white; margin-left:0px"></i> Tambah</button></a>
            </div>
            <!-- /widget-header -->
            <div class="widget-content">
                <div class="widget big-stats-container">
                    <?php
                        ...
                        $result = $conn->prepare("SELECT * FROM tb_anggota ORDER BY nama ASC LIMIT ".$limit_start.",".$limit);
                        $result->execute();
                                        ...
                                        <?php } ?>                                   
                                                    ...
                                                    <div style="cf">
														<center><ul class="pagination">
															...
															?>
																<li><a href="?page=user&hals=1">Pertama</a></li>
																<li><a href="?page=user&?hals=<?php echo $link_prev; ?>">&laquo;</a></li>
															<?php
															}
															?>
															<?php
																// Buat query untuk menghitung semua jumlah data
																$sql2 = $conn->prepare("SELECT COUNT(*) AS jumlah FROM tb_anggota");
															...
															?>
																<li<?php echo $link_active; ?>><a href="?page=user&hals=<?php echo $i; ?>"><?php echo $i; ?></a></li>
															<?php 
																}
															?>
															<!-- LINK NEXT AND LAST -->
															...
															?>
																<li><a href="?page=user&hals=<?php echo $link_next; ?>">&raquo;</a></li>
																<li><a href="?page=user&hals=<?php echo $jumlah_page; ?>">Terakhir</a></li>
															<?php
															}
															?>
														</ul></center>
